...
int main()
{
    FILE *ptr;
    char ch[100];
    ptr = fopen("C:\\giri class\\C Launguage Practical\\file handling\\countWCNoofL.txt","r");
    int wCount=0;
    int cCount=1;
    int lCount=1;
    int  i;
...
int main(){
    FILE *ptr,*ptr1;
ptr = fopen("C:\\giri class\\C Launguage Practical\\file handling\\removeword.txt","r");
ptr1 = fopen("C:\\giri class\\C Launguage Practical\\file handling\\vaibhav.txt","a+");
char ch[90];
char filech[90];

printf("Enter the name:");
scanf("%s",&ch);
while(fscanf(ptr,"%s",filech)!=-1){
    if(strcmp(filech,ch)!=0){
            printf("%s\n",filech);
       fputs(filech,ptr1);
...
int main(){
    FILE *ptr,*ptr1;
ptr = fopen("C:\\giri class\\C Launguage Practical\\file handling\\removeline.txt","r");
ptr1 = fopen("C:\\giri class\\C Launguage Practical\\file handling\\mote.txt","a+");
int line;
char filech[90];
int linecount=0;
char ch;

printf("Enter line you have remove it:");
scanf("%d",&line);
ch=getc(ptr);
while(fgets(filech,90,ptr)!=-1){
        if(ch=='\n')
        ++linecount;
